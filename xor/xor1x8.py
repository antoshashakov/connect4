...
model.add(tf.keras.layers.Dense(8, input_dim=2, activation='relu')) #"hidden layer" with 8 neurons; relu funct. is 0 for negative inputs and x for nonnegative ones
